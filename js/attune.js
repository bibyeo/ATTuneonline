...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Fn,depthTest:!1,depthWrite:!1})}function Pm(i,e,t){return new rn({name:"SphericalGaussianBlur",defines:{SAMPLES:Tm,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${i}.0`},uniforms:{envMap:{value:null},sigma:{value:0},mipInt:{value:0}},vertexShader:_o(),fragmentShader:`
		...
		`,blending:Fn,depthTest:!1,depthWrite:!1})}function eu(){return new rn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:_o(),fragmentShader:`
		...
		`,blending:Fn,depthTest:!1,depthWrite:!1})}function tu(){return new rn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:_o(),fragmentShader:`
	...
	`}var mo=class extends Kt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},s=[n,n,n,n,n,n];this.texture=new Fs(s),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},s=new si(5,5,5),r=new rn({name:"CubemapFromEquirect",uniforms:Ri(n.uniforms),vertexShader:n.vertexShader,fragmentShader:n.fragmentShader,side:Yt,blending:Fn});r.uniforms.tEquirect.value=t;let a=new $e(s,r),o=t.minFilter;return t.minFilter===ui&&(t.minFilter=kt),new va(1,10,this).update(e,a),t.minFilter=o,a.geometry.dispose(),a.material.dispose(),this}clear(e,t=!0,n=!0,s=!0){let r=e.getRenderTarget();for(let a=0;a<6;a++)e.setRenderTarget(this,a),e.clear(t,n,s);e.setRenderTarget(r)}};function Im(i){let e=new WeakMap,t=new WeakMap,n=null;function s(h,f=!1){return h==null?null:f?a(h):r(h)}function r(h){if(h&&h.isTexture){let f=h.mapping;if(f===wa||f===Ta)if(e.has(h)){let p=e.get(h).texture;return o(p,h.mapping)}else{let p=h.image;if(p&&p.height>0){let y=new mo(p.height);return y.fromEquirectangularTexture(i,h),e.set(h,y),h.addEventListener("dispose",c),o(y.texture,h.mapping)}else return null}}return h}function a(h){if(h&&h.isTexture){let f=h.mapping,p=f===wa||f===Ta,y=f===hi||f===Ci;if(p||y){let m=t.get(h),g=m!==void 0?m.texture.pmremVersion:0;if(h.isRenderTargetTexture&&h.pmremVersion!==g)return n===null&&(n=new po(i)),m=p?n.fromEquirectangular(h,m):n.fromCubemap(h,m),m.texture.pmremVersion=h.pmremVersion,t.set(h,m),m.texture;if(m!==void 0)return m.texture;{let S=h.image;return p&&S&&S.height>0||y&&S&&l(S)?(n===null&&(n=new po(i)),m=p?n.fromEquirectangular(h):n.fromCubemap(h),m.texture.pmremVersion=h.pmremVersion,t.set(h,m),h.addEventListener("dispose",d),m.texture):null}}}return h}function o(h,f){return f===wa?h.mapping=hi:f===Ta&&(h.mapping=Ci),h}function l(h){let f=0,p=6;for(let y=0;y<p;y++)h[y]!==void 0&&f++;return f===p}function c(h){let f=h.target;f.removeEventListener("dispose",c);let p=e.get(f);p!==void 0&&(e.delete(f),p.dispose())}function d(h){let f=h.target;f.removeEventListener("dispose",d);let p=t.get(f);p!==void 0&&(t.delete(f),p.dispose())}function u(){e=new WeakMap,t=new WeakMap,n!==null&&(n.dispose(),n=null)}return{get:s,dispose:u}}function Lm(i){let e={};function t(n){if(e[n]!==void 0)return e[n];let s=i.getExtension(n);return e[n]=s,s}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){let s=t(n);return s===null&&bi("WebGLRenderer: "+n+" extension not supported."),s}}}function Dm(i,e,t,n){let s={},r=new WeakMap;function a(u){let h=u.target;h.index!==null&&e.remove(h.index);for(let p in h.attributes)e.remove(h.attributes[p]);h.removeEventListener("dispose",a),delete s[h.id];let f=r.get(h);f&&(e.remove(f),r.delete(h)),n.releaseStatesOfGeometry(h),h.isInstancedBufferGeometry===!0&&delete h._maxInstanceCount,t.memory.geometries--}function o(u,h){return s[h.id]===!0||(h.addEventListener("dispose",a),s[h.id]=!0,t.memory.geometries++),h}function l(u){let h=u.attributes;for(let f in h)e.update(h[f],i.ARRAY_BUFFER)}function c(u){let h=[],f=u.index,p=u.attributes.position,y=0;if(p===void 0)return;if(f!==null){let S=f.array;y=f.version;for(let w=0,v=S.length;w<v;w+=3){let T=S[w+0],b=S[w+1],A=S[w+2];h.push(T,b,b,A,A,T)}}else{let S=p.array;y=p.version;for(let w=0,v=S.length/3-1;w<v;w+=3){let T=w+0,b=w+1,A=w+2;h.push(T,b,b,A,A,T)}}let m=new(p.count>=65535?Ns:Ds)(h,1);m.version=y;let g=r.get(u);g&&e.remove(g),r.set(u,m)}function d(u){let h=r.get(u);if(h){let f=u.index;f!==null&&h.version<f.version&&c(u)}else c(u);return r.get(u)}return{get:o,update:l,getWireframeAttribute:d}}function Nm(i,e,t){let n;function s(u){n=u}let r,a;function o(u){r=u.type,a=u.bytesPerElement}function l(u,h){i.drawElements(n,h,r,u*a),t.update(h,n,1)}function c(u,h,f){f!==0&&(i.drawElementsInstanced(n,h,r,u*a,f),t.update(h,n,f))}function d(u,h,f){if(f===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,h,0,r,u,0,f);let y=0;for(let m=0;m<f;m++)y+=h[m];t.update(y,n,1)}this.setMode=s,this.setIndex=o,this.render=l,this.renderInstances=c,this.renderMultiDraw=d}function Um(i){let e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(r,a,o){switch(t.calls++,a){case i.TRIANGLES:t.triangles+=o*(r/3);break;case i.LINES:t.lines+=o*(r/2);break;case i.LINE_STRIP:t.lines+=o*(r-1);break;case i.LINE_LOOP:t.lines+=o*r;break;case i.POINTS:t.points+=o*r;break;default:De("WebGLInfo: Unknown draw mode:",a);break}}function s(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:s,update:n}}function Fm(i,e,t){let n=new WeakMap,s=new yt;function r(a,o,l){let c=a.morphTargetInfluences,d=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,u=d!==void 0?d.length:0,h=n.get(o);if(h===void 0||h.count!==u){let E=function(){A.dispose(),n.delete(o),o.removeEventListener("dispose",E)};h!==void 0&&h.texture.dispose();let f=o.morphAttributes.position!==void 0,p=o.morphAttributes.normal!==void 0,y=o.morphAttributes.color!==void 0,m=o.morphAttributes.position||[],g=o.morphAttributes.normal||[],S=o.morphAttributes.color||[],w=0;f===!0&&(w=1),p===!0&&(w=2),y===!0&&(w=3);let v=o.attributes.position.count*w,T=1;v>e.maxTextureSize&&(T=Math.ceil(v/e.maxTextureSize),v=e.maxTextureSize);let b=new Float32Array(v*T*4*u),A=new Rs(b,v,T,u);A.type=wn,A.needsUpdate=!0;let x=w*4;for(let P=0;P<u;P++){let U=m[P],F=g[P],V=S[P],D=v*T*4*P;for(let H=0;H<U.count;H++){let Z=H*x;f===!0&&(s.fromBufferAttribute(U,H),b[D+Z+0]=s.x,b[D+Z+1]=s.y,b[D+Z+2]=s.z,b[D+Z+3]=0),p===!0&&(s.fromBufferAttribute(F,H),b[D+Z+4]=s.x,b[D+Z+5]=s.y,b[D+Z+6]=s.z,b[D+Z+7]=0),y===!0&&(s.fromBufferAttribute(V,H),b[D+Z+8]=s.x,b[D+Z+9]=s.y,b[D+Z+10]=s.z,b[D+Z+11]=V.itemSize===4?s.w:1)}}h={count:u,texture:A,size:new Te(v,T)},n.set(o,h),o.addEventListener("dispose",E)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)l.getUniforms().setValue(i,"morphTexture",a.morphTexture,t);else{let f=0;for(let y=0;y<c.length;y++)f+=c[y];let p=o.morphTargetsRelative?1:1-f;l.getUniforms().setValue(i,"morphTargetBaseInfluence",p),l.getUniforms().setValue(i,"morphTargetInfluences",c)}l.getUniforms().setValue(i,"morphTargetsTexture",h.texture,t),l.getUniforms().setValue(i,"morphTargetsTextureSize",h.size)}return{update:r}}function Om(i,e,t,n,s){let r=new WeakMap;function a(c){let d=s.render.frame,u=c.geometry,h=e.get(c,u);if(r.get(h)!==d&&(e.update(h),r.set(h,d)),c.isInstancedMesh&&(c.hasEventListener("dispose",l)===!1&&c.addEventListener("dispose",l),r.get(c)!==d&&(t.update(c.instanceMatrix,i.ARRAY_BUFFER),c.instanceColor!==null&&t.update(c.instanceColor,i.ARRAY_BUFFER),r.set(c,d))),c.isSkinnedMesh){let f=c.skeleton;r.get(f)!==d&&(f.update(),r.set(f,d))}return h}function o(){r=new WeakMap}function l(c){let d=c.target;d.removeEventListener("dispose",l),n.releaseStatesOfObject(d),t.remove(d.instanceMatrix),d.instanceColor!==null&&t.remove(d.instanceColor)}return{update:a,dispose:o}}var km={[Tl]:"LINEAR_TONE_MAPPING",[El]:"REINHARD_TONE_MAPPING",[Al]:"CINEON_TONE_MAPPING",[Cl]:"ACES_FILMIC_TONE_MAPPING",[Pl]:"AGX_TONE_MAPPING",[Il]:"NEUTRAL_TONE_MAPPING",[Rl]:"CUSTOM_TONE_MAPPING"};function Bm(i,e,t,n,s,r){let a=new Kt(e,t,{type:i,depthBuffer:s,stencilBuffer:r,samples:n?4:0,storeMultisampledDepthBuffer:!1,storeMultisampledStencilBuffer:!1,resolveDepthBuffer:!1,resolveStencilBuffer:!1}),o=null,l=null,c=new Ct;c.setAttribute("position",new et([-1,3,0,-1,-1,0,3,-1,0],3)),c.setAttribute("uv",new et([0,2,0,0,2,0],2));let d=new oa({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),u=new $e(c,d),h=new os(-1,1,1,-1,0,1),f=null,p=null,y=!1,m,g=null,S=[],w=!1;this.setSize=function(v,T){a.setSize(v,T),o!==null&&o.setSize(v,T),l!==null&&l.setSize(v,T);for(let b=0;b<S.length;b++){let A=S[b];A.setSize&&A.setSize(v,T)}},this.setEffects=function(v){S=v,w=S.length>0&&S[0].isRenderPass===!0;let T=a.width,b=a.height;S.length>0&&o===null&&(o=new Kt(T,b,{type:Tn,depthBuffer:!1,stencilBuffer:!1}),l=new Kt(T,b,{type:Tn,depthBuffer:!1,stencilBuffer:!1}));for(let A=0;A<S.length;A++){let x=S[A];x.setSize&&x.setSize(T,b)}},this.begin=function(v,T){if(y||v.toneMapping===bn&&S.length===0)return!1;if(g=T,T!==null){let b=T.width,A=T.height;(a.width!==b||a.height!==A)&&this.setSize(b,A)}return w===!1&&v.setRenderTarget(a),m=v.toneMapping,v.toneMapping=bn,!0},this.hasRenderPass=function(){return w},this.end=function(v,T){v.toneMapping=m,y=!0;let b=a,A=o;for(let x=0;x<S.length;x++){let E=S[x];E.enabled!==!1&&(E.render(v,A,b,T),E.needsSwap!==!1&&(b=A,A=A===o?l:o))}if(f!==v.outputColorSpace||p!==v.toneMapping){f=v.outputColorSpace,p=v.toneMapping,d.defines={},qe.getTransfer(f)===it&&(d.defines.SRGB_TRANSFER="");let x=km[p];x&&(d.defines[x]=""),d.needsUpdate=!0}d.uniforms.tDiffuse.value=b.texture,v.setRenderTarget(g),v.render(u,h),g=null,y=!1},this.isCompositing=function(){return y},this.dispose=function(){a.dispose(),o!==null&&o.dispose(),l!==null&&l.dispose(),c.dispose(),d.dispose()}}var Mu=new qt,sc=new ii(1,1),bu=new Rs,Su=new Yr,wu=new Fs,nu=[],iu=[],su=new Float32Array(16),ru=new Float32Array(9),au=new Float32Array(4);function gs(i,e,t){let n=i[0];if(n<=0||n>0)return i;let s=e*t,r=nu[s];if(r===void 0&&(r=new Float32Array(s),nu[s]=r),e!==0){n.toArray(r,0);for(let a=1,o=0;a!==e;++a)o+=t,i[a].toArray(r,o)}return r}function Rt(i,e){if(i.length!==e.length)return!1;for(let t=0,n=i.length;t<n;t++)if(i[t]!==e[t])return!1;return!0}function Pt(i,e){for(let t=0,n=e.length;t<n;t++)i[t]=e[t]}function yo(i,e){let t=iu[e];t===void 0&&(t=new Int32Array(e),iu[e]=t);for(let n=0;n!==e;++n)t[n]=i.allocateTextureUnit();return t}function zm(i,e){let t=this.cache;t[0]!==e&&(i.uniform1f(this.addr,e),t[0]=e)}function Vm(i,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Rt(t,e))return;i.uniform2fv(this.addr,e),Pt(t,e)}}function Hm(i,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(i.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(Rt(t,e))return;i.uniform3fv(this.addr,e),Pt(t,e)}}function Gm(i,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Rt(t,e))return;i.uniform4fv(this.addr,e),Pt(t,e)}}function Wm(i,e){let t=this.cache,n=e.elements;if(n===void 0){if(Rt(t,e))return;i.uniformMatrix2fv(this.addr,!1,e),Pt(t,e)}else{if(Rt(t,n))return;au.set(n),i.uniformMatrix2fv(this.addr,!1,au),Pt(t,n)}}function Xm(i,e){let t=this.cache,n=e.elements;if(n===void 0){if(Rt(t,e))return;i.uniformMatrix3fv(this.addr,!1,e),Pt(t,e)}else{if(Rt(t,n))return;ru.set(n),i.uniformMatrix3fv(this.addr,!1,ru),Pt(t,n)}}function qm(i,e){let t=this.cache,n=e.elements;if(n===void 0){if(Rt(t,e))return;i.uniformMatrix4fv(this.addr,!1,e),Pt(t,e)}else{if(Rt(t,n))return;su.set(n),i.uniformMatrix4fv(this.addr,!1,su),Pt(t,n)}}function Ym(i,e){let t=this.cache;t[0]!==e&&(i.uniform1i(this.addr,e),t[0]=e)}function $m(i,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Rt(t,e))return;i.uniform2iv(this.addr,e),Pt(t,e)}}function Zm(i,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Rt(t,e))return;i.uniform3iv(this.addr,e),Pt(t,e)}}function Jm(i,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Rt(t,e))return;i.uniform4iv(this.addr,e),Pt(t,e)}}function Km(i,e){let t=this.cache;t[0]!==e&&(i.uniform1ui(this.addr,e),t[0]=e)}function jm(i,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Rt(t,e))return;i.uniform2uiv(this.addr,e),Pt(t,e)}}function Qm(i,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Rt(t,e))return;i.uniform3uiv(this.addr,e),Pt(t,e)}}function e0(i,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Rt(t,e))return;i.uniform4uiv(this.addr,e),Pt(t,e)}}function t0(i,e,t){let n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s);let r;this.type===i.SAMPLER_2D_SHADOW?(sc.compareFunction=t.isReversedDepthBuffer()?ho:co,r=sc):r=Mu,t.setTexture2D(e||r,s)}function n0(i,e,t){let n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTexture3D(e||Su,s)}function i0(i,e,t){let n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTextureCube(e||wu,s)}function s0(i,e,t){let n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTexture2DArray(e||bu,s)}function r0(i){switch(i){case 5126:return zm;case 35664:return Vm;case 35665:return Hm;case 35666:return Gm;case 35674:return Wm;case 35675:return Xm;case 35676:return qm;case 5124:case 35670:return Ym;case 35667:case 35671:return $m;case 35668:case 35672:return Zm;case 35669:case 35673:return Jm;case 5125:return Km;case 36294:return jm;case 36295:return Qm;case 36296:return e0;case 35678:case 36198:case 36298:case 36306:case 35682:return t0;case 35679:case 36299:case 36307:return n0;case 35680:case 36300:case 36308:case 36293:return i0;case 36289:case 36303:case 36311:case 36292:return s0}}function a0(i,e){i.uniform1fv(this.addr,e)}function o0(i,e){let t=gs(e,this.size,2);i.uniform2fv(this.addr,t)}function l0(i,e){let t=gs(e,this.size,3);i.uniform3fv(this.addr,t)}function c0(i,e){let t=gs(e,this.size,4);i.uniform4fv(this.addr,t)}function h0(i,e){let t=gs(e,this.size,4);i.uniformMatrix2fv(this.addr,!1,t)}function u0(i,e){let t=gs(e,this.size,9);i.uniformMatrix3fv(this.addr,!1,t)}function d0(i,e){let t=gs(e,this.size,16);i.uniformMatrix4fv(this.addr,!1,t)}function f0(i,e){i.uniform1iv(this.addr,e)}function p0(i,e){i.uniform2iv(this.addr,e)}function m0(i,e){i.uniform3iv(this.addr,e)}function g0(i,e){i.uniform4iv(this.addr,e)}function _0(i,e){i.uniform1uiv(this.addr,e)}function y0(i,e){i.uniform2uiv(this.addr,e)}function x0(i,e){i.uniform3uiv(this.addr,e)}function v0(i,e){i.uniform4uiv(this.addr,e)}function M0(i,e,t){let n=this.cache,s=e.length,r=yo(t,s);Rt(n,r)||(i.uniform1iv(this.addr,r),Pt(n,r));let a;this.type===i.SAMPLER_2D_SHADOW?a=sc:a=Mu;for(let o=0;o!==s;++o)t.setTexture2D(e[o]||a,r[o])}function b0(i,e,t){let n=this.cache,s=e.length,r=yo(t,s);Rt(n,r)||(i.uniform1iv(this.addr,r),Pt(n,r));for(let a=0;a!==s;++a)t.setTexture3D(e[a]||Su,r[a])}function S0(i,e,t){let n=this.cache,s=e.length,r=yo(t,s);Rt(n,r)||(i.uniform1iv(this.addr,r),Pt(n,r));for(let a=0;a!==s;++a)t.setTextureCube(e[a]||wu,r[a])}function w0(i,e,t){let n=this.cache,s=e.length,r=yo(t,s);Rt(n,r)||(i.uniform1iv(this.addr,r),Pt(n,r));for(let a=0;a!==s;++a)t.setTexture2DArray(e[a]||bu,r[a])}function T0(i){switch(i){case 5126:return a0;case 35664:return o0;case 35665:return l0;case 35666:return c0;case 35674:return h0;case 35675:return u0;case 35676:return d0;case 5124:case 35670:return f0;case 35667:case 35671:return p0;case 35668:case 35672:return m0;case 35669:case 35673:return g0;case 5125:return _0;case 36294:return y0;case 36295:return x0;case 36296:return v0;case 35678:case 36198:case 36298:case 36306:case 35682:return M0;case 35679:case 36299:case 36307:return b0;case 35680:case 36300:case 36308:case 36293:return S0;case 36289:case 36303:case 36311:case 36292:return w0}}var rc=class{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=r0(t.type)}},ac=class{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=T0(t.type)}},oc=class{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){let s=this.seq;for(let r=0,a=s.length;r!==a;++r){let o=s[r];o.setValue(e,t[o.id],n)}}},nc=/(\w+)(\])?(\[|\.)?/g;function ou(i,e){i.seq.push(e),i.map[e.id]=e}function E0(i,e,t){let n=i.name,s=n.length;for(nc.lastIndex=0;;){let r=nc.exec(n),a=nc.lastIndex,o=r[1],l=r[2]==="]",c=r[3];if(l&&(o=o|0),c===void 0||c==="["&&a+2===s){ou(t,c===void 0?new rc(o,i,e):new ac(o,i,e));break}else{let u=t.map[o];u===void 0&&(u=new oc(o),ou(t,u)),t=u}}}var ms=class{constructor(e,t){this.seq=[],this.map={};let n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let a=0;a<n;++a){let o=e.getActiveUniform(t,a),l=e.getUniformLocation(t,o.name);E0(o,l,this)}let s=[],r=[];for(let a of this.seq)a.type===e.SAMPLER_2D_SHADOW||a.type===e.SAMPLER_CUBE_SHADOW||a.type===e.SAMPLER_2D_ARRAY_SHADOW?s.push(a):r.push(a);s.length>0&&(this.seq=s.concat(r))}setValue(e,t,n,s){let r=this.map[t];r!==void 0&&r.setValue(e,n,s)}setOptional(e,t,n){let s=t[n];s!==void 0&&this.setValue(e,n,s)}static upload(e,t,n,s){for(let r=0,a=t.length;r!==a;++r){let o=t[r],l=n[o.id];l.needsUpdate!==!1&&o.setValue(e,l.value,s)}}static seqWithValue(e,t){let n=[];for(let s=0,r=e.length;s!==r;++s){let a=e[s];a.id in t&&n.push(a)}return n}};function lu(i,e,t){let n=i.createShader(e);return i.shaderSource(n,t),i.compileShader(n),n}var A0=37297,C0=0;function R0(i,e){let t=i.split(`
`),n=[],s=Math.max(e-6,0),r=Math.min(e+6,t.length);for(let a=s;a<r;a++){let o=a+1;n.push(`${o===e?">":" "} ${o}: ${t[a]}`)}return n.join(`
`)}var cu=new Ne;function P0(i){qe._getMatrix(cu,qe.workingColorSpace,i);let e=`mat3( ${cu.elements.map(t=>t.toFixed(4))} )`;switch(qe.getTransfer(i)){case As:return[e,"LinearTransferOETF"];case it:return[e,"sRGBTransferOETF"];default:return Ie("WebGLProgram: Unsupported color space: ",i),[e,"LinearTransferOETF"]}}function hu(i,e,t){let n=i.getShaderParameter(e,i.COMPILE_STATUS),r=(i.getShaderInfoLog(e)||"").trim();if(n&&r==="")return"";let a=/ERROR: 0:(\d+)/.exec(r);if(a){let o=parseInt(a[1]);return t.toUpperCase()+`
...
`)}var L0={[Tl]:"Linear",[El]:"Reinhard",[Al]:"Cineon",[Cl]:"ACESFilmic",[Pl]:"AgX",[Il]:"Neutral",[Rl]:"Custom"};function D0(i,e){let t=L0[e];return t===void 0?(Ie("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+i+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}var fo=new R;function N0(){qe.getLuminanceCoefficients(fo);let i=fo.x.toFixed(4),e=fo.y.toFixed(4),t=fo.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
`)}function O0(i,e){let t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let s=0;s<n;s++){let r=i.getActiveAttrib(e,s),a=r.name,o=1;r.type===i.FLOAT_MAT2&&(o=2),r.type===i.FLOAT_MAT3&&(o=3),r.type===i.FLOAT_MAT4&&(o=4),t[a]={type:r.type,location:i.getAttribLocation(e,a),locationSize:o}}return t}function ar(i){return i!==""}function uu(i,e){let t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_SUN_LIGHTS/g,e.numSunLights).replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_SUN_LIGHT_SHADOWS/g,e.numSunLightShadows).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function du(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}var k0=/^[ \t]*#include +<([\w\d./]+)>/gm;function lc(i){return i.replace(k0,z0)}var B0=new Map;function z0(i,e){let t=Be[e];if(t===void 0){let n=B0.get(e);if(n!==void 0)t=Be[n],Ie('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("THREE.WebGLProgram: Can not resolve #include <"+e+">")}return lc(t)}var V0=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function fu(i){return i.replace(V0,H0)}function H0(i,e,t,n){let s="";for(let r=parseInt(e);r<parseInt(t);r++)s+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function pu(i){let e=`precision ${i.precision} float;
...
#define LOW_PRECISION`),e}var G0={[Ys]:"SHADOWMAP_TYPE_PCF",[cs]:"SHADOWMAP_TYPE_VSM"};function W0(i){return G0[i.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}var X0={[hi]:"ENVMAP_TYPE_CUBE",[Ci]:"ENVMAP_TYPE_CUBE",[$s]:"ENVMAP_TYPE_CUBE_UV"};function q0(i){return i.envMap===!1?"ENVMAP_TYPE_CUBE":X0[i.envMapMode]||"ENVMAP_TYPE_CUBE"}var Y0={[Ci]:"ENVMAP_MODE_REFRACTION"};function $0(i){return i.envMap===!1?"ENVMAP_MODE_REFLECTION":Y0[i.envMapMode]||"ENVMAP_MODE_REFLECTION"}var Z0={[Sa]:"ENVMAP_BLENDING_MULTIPLY",[Ih]:"ENVMAP_BLENDING_MIX",[Lh]:"ENVMAP_BLENDING_ADD"};function J0(i){return i.envMap===!1?"ENVMAP_BLENDING_NONE":Z0[i.combine]||"ENVMAP_BLENDING_NONE"}function K0(i){let e=i.envMapCubeUVHeight;if(e===null)return null;let t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function j0(i,e,t,n){let s=i.getContext(),r=t.defines,a=t.vertexShader,o=t.fragmentShader,l=W0(t),c=q0(t),d=$0(t),u=J0(t),h=K0(t),f=U0(t),p=F0(r),y=s.createProgram(),m,g,S=t.glslVersion?"#version "+t.glslVersion+`
...
`)+`
`+g);let w=S+m+a,v=S+g+o,T=lu(s,s.VERTEX_SHADER,w),b=lu(s,s.FRAGMENT_SHADER,v);s.attachShader(y,T),s.attachShader(y,b),t.index0AttributeName!==void 0?s.bindAttribLocation(y,0,t.index0AttributeName):t.hasPositionAttribute===!0&&s.bindAttribLocation(y,0,"position"),s.linkProgram(y);function A(U){if(i.debug.checkShaderErrors){let F=s.getProgramInfoLog(y)||"",V=s.getShaderInfoLog(T)||"",D=s.getShaderInfoLog(b)||"",H=F.trim(),Z=V.trim(),J=D.trim(),ie=!0,q=!0;if(s.getProgramParameter(y,s.LINK_STATUS)===!1)if(ie=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,y,T,b);else{let ee=hu(s,T,"vertex"),ne=hu(s,b,"fragment");De("WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(y,s.VALIDATE_STATUS)+`
...
Reply with only JSON: {"marks": ["full"|"partial"|"missed", ...one per key point in order], "tip": "one short encouraging sentence about what to listen for next time"}`;try{let o=await xc();if(o&&o.json){let l=await o.json(r,{modelTier:"quick"});if(l&&Array.isArray(l.marks)&&l.marks.length===n.length)return a(l.marks,"ai",l.tip)}}catch{}if(or.markingEndpoint)try{let o=await fetch(or.markingEndpoint,{method:"POST",headers:{"content-type":"application/json"},body:JSON.stringify({transcript:t,keyPoints:n.map(l=>l.p),notes:s.slice(0,4e3)})});if(o.ok){let l=await o.json();if(Array.isArray(l.marks)&&l.marks.length===n.length)return a(l.marks,"ai",l.tip)}}catch{}return a(n.map(o=>Dg(s,o)),"keywords");function a(o,l,c){let d=o.map(h=>Pu[h]!==void 0?h:"missed");return{score:d.reduce((h,f)=>h+Pu[f],0)/n.length,method:l,tip:c,points:n.map((h,f)=>({p:h.p,mark:d[f]}))}}}function Du(i,e){let t={};So.forEach(c=>t[c.id]=[]);for(let c of e)if(c.cats)for(let d of c.cats)t[d].push(c.score);let n={};So.forEach(c=>{let d=t[c.id];n[c.id]=d.length?Math.round(d.reduce((u,h)=>u+h,0)/d.length*100):null});let s=Object.values(n).filter(c=>c!==null),r=Math.round(s.reduce((c,d)=>c+d,0)/s.length),a=r>=85?"Locked in":r>=70?"Tuned in":r>=50?"In and out":"Lots of static",o=[];e.forEach(c=>c.cues&&c.cues.forEach(d=>d.target&&o.push({part:c.title,t:d.keyT-c.t0,rt:d.hit?d.rt:null})));let l=null;if(o.length){let c=o.filter(h=>h.rt!==null).map(h=>h.rt).sort((h,f)=>h-f),d=c.length?c[Math.floor(c.length/2)]:0,u=o.filter(h=>h.rt===null||h.rt>Math.max(1.6,d*1.8));if(!u.length)l={ok:!0,text:"No drift spotted \u2014 your reactions stayed steady the whole way."};else{let h=u[0],f=Math.floor(h.t/60),p=Math.round(h.t%60);l={ok:!1,text:`Your attention first slipped ${h.t<4?`right at the start of \u201C${h.part}\u201D`:`${f?f+" min ":""}${p} s into \u201C${h.part}\u201D`}${h.rt===null?" \u2014 you missed a call there":" \u2014 your reaction slowed right down"}.${u.length>1?` It slipped ${u.length} times in all.`:""}`,count:u.length}}}return{sub:n,overall:r,band:a,drift:l}}var Eo=new URLSearchParams(location.search),lt=Math.max(1,+Eo.get("speed")||1),pi=Eo.has("auto"),vt=(i,e=document)=>e.querySelector(i),qn=(i,e,t)=>{let n=document.createElement(i);return e&&(n.className=e),t!==void 0&&(n.innerHTML=t),n},Ze=i=>String(i).replace(/[&<>"]/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;"})[e]);var Ao=i=>{let e=i.slice();for(let t=e.length-1;t>0;t--){let n=Math.floor(Math.random()*(t+1));[e[t],e[n]]=[e[n],e[t]]}return e},pn={get(i){try{return JSON.parse(localStorage.getItem("attune."+i))}catch{return null}},set(i,e){try{localStorage.setItem("attune."+i,JSON.stringify(e))}catch{}}},xe=new bo;xe.speed=lt;var Lt=new Mo(vt("#gl"));Lt.onCut=()=>{let i=vt("#fade");i.classList.remove("on"),i.offsetWidth,i.classList.add("on")};var Ye={hud:vt("#hud"),dock:vt("#dock"),big:vt("#big"),screens:vt("#screens"),phone:vt("#phone"),toasts:vt("#toasts"),tip:vt("#tip"),loader:vt("#loader")},Ve={level:null,results:[],talk:[],acts:[],t0:0,running:!1,runId:0},ln=new Set;function vc(){Ve.runId++,Ve.running=!1;for(let i of[...ln])try{i()}catch{}ln.clear(),Ve.talk=[],Ve.acts=[]}window.__attune=Ve;xc();var Uu,It={v:(Uu=pn.get("vol"))!=null?Uu:.8,muted:!!pn.get("muted")};function wo(){xe.setVolume(It.muted?0:It.v);let i=vt("#vol");i.classList.toggle("muted",It.muted||It.v===0),i.classList.toggle("low",It.v<.4),vt("#vol-range").value=Math.round(It.v*100),vt("#vol-val").textContent=It.muted?"Off":Math.round(It.v*100),vt("#vol-mute").textContent=It.muted?"Unmute":"Mute",vt("#vol-btn").setAttribute("aria-label",It.muted?"Volume (muted)":`Volume ${Math.round(It.v*100)}%`),pn.set("vol",It.v),pn.set("muted",It.muted)}(function(){let e=vt("#vol-pop"),t=vt("#vol-btn"),n=s=>{e.hidden=!s,t.setAttribute("aria-expanded",s?"true":"false")};t.addEventListener("click",s=>{s.stopPropagation(),n(e.hidden)}),vt("#vol-range").addEventListener("input",s=>{It.v=+s.target.value/100,It.muted=!1,wo()}),vt("#vol-mute").addEventListener("click",()=>{It.muted=!It.muted,wo()}),document.addEventListener("pointerdown",s=>{!e.hidden&&!vt("#vol").contains(s.target)&&n(!1)}),document.addEventListener("keydown",s=>{let r=document.activeElement&&document.activeElement.tagName,a=r==="TEXTAREA"||r==="INPUT"&&document.activeElement.type!=="range";(s.key==="m"||s.key==="M")&&!a&&(It.muted=!It.muted,wo()),s.key==="Escape"&&n(!1)}),wo()})();function Sc(i,{accent:e=-1,sub:t="",cls:n=""}={}){let s=i.split(" ");Ye.big.className="big "+n,Ye.big.innerHTML=`<div class="big-words">${s.map((r,a)=>`<span class="w${a===e?" accent":""}" style="--i:${a}">${Ze(r)}</span>`).join(" ")}</div>${t?`<div class="big-sub" style="--i:${s.length}">${Ze(t)}</div>`:""}`,Ye.big.hidden=!1,xe.whoosh(.9)}function lr(){Ye.big.hidden=!0,Ye.big.innerHTML=""}function Io(i="Hold to tune in",{onProgress:e}={}){let t=qn("button","hold",`<svg viewBox="0 0 44 44" aria-hidden="true"><circle cx="22" cy="22" r="19" class="track"/><circle cx="22" cy="22" r="19" class="fill" pathLength="100"/></svg><span>${Ze(i)}</span><kbd>hold space</kbd>`);t.type="button";let n=()=>{},s=new Promise(r=>{let a=0,o=0,l=!1,c=()=>{let p=Math.min(1,(performance.now()-a)/or.holdMs);if(t.style.setProperty("--k",p),e&&e(p),xe.swell(p),xe.holdTone(p),Lt.setPush(p*.5),p>=1){l=!0,u(!0),r();return}o=requestAnimationFrame(c)},d=p=>{l||a||(p&&p.preventDefault(),xe.unlock(),a=performance.now(),t.classList.add("holding"),c())},u=p=>{cancelAnimationFrame(o),a=0,t.classList.remove("holding"),p||t.style.setProperty("--k",0),xe.holdTone(0),xe.swell(0),Lt.setPush(0),p&&(xe.whoosh(1.2),document.removeEventListener("keydown",h),document.removeEventListener("keyup",f))},h=p=>{var y,m;document.querySelector(".modal")||(p.code==="Space"||p.code==="Enter")&&!p.repeat&&((y=document.activeElement)==null?void 0:y.tagName)!=="TEXTAREA"&&((m=document.activeElement)==null?void 0:m.tagName)!=="INPUT"&&d(p)},f=p=>{(p.code==="Space"||p.code==="Enter")&&!l&&u(!1)};t.addEventListener("pointerdown",d),t.addEventListener("pointerup",()=>!l&&u(!1)),t.addEventListener("pointerleave",()=>!l&&a&&u(!1)),t.addEventListener("contextmenu",p=>p.preventDefault()),document.addEventListener("keydown",h),document.addEventListener("keyup",f),n=()=>{l=!0,cancelAnimationFrame(o),document.removeEventListener("keydown",h),document.removeEventListener("keyup",f),xe.holdTone(0),Lt.setPush(0)},ln.add(n),pi&&setTimeout(()=>{l||(l=!0,xe.unlock(),u(!0),r())},60)});return s.then(()=>ln.delete(n)),{el:t,done:s,dispose:()=>{n(),ln.delete(n)}}}function Li(i,e=""){Ye.screens.innerHTML="";let t=qn("section","screen "+e,i);return Ye.screens.appendChild(t),t}function Co(){Ye.screens.innerHTML=""}function tn(i,e=""){Ye.dock.innerHTML="",Ye.dock.className="dock "+e,i?(Ye.dock.appendChild(i),Ye.dock.hidden=!1):Ye.dock.hidden=!0}var Ro=()=>document.fullscreenElement||document.webkitFullscreenElement;function wc(){let i=document.documentElement;if(Ro())return;let e=i.requestFullscreen||i.webkitRequestFullscreen;if(e){let t=e.call(i);t&&t.catch&&t.catch(()=>{})}}function Ug(){let i=document.exitFullscreen||document.webkitExitFullscreen;if(Ro()&&i){let e=i.call(document);e&&e.catch&&e.catch(()=>{})}}(function(){let e=vt("#fs-btn");if(!e)return;if(!(document.fullscreenEnabled||document.webkitFullscreenEnabled)){e.hidden=!0;return}let t=()=>{let n=!!Ro();e.classList.toggle("on",n),e.setAttribute("aria-label",n?"Exit full screen":"Full screen"),e.title=n?"Exit full screen":"Full screen"};e.addEventListener("click",()=>Ro()?Ug():wc()),document.addEventListener("fullscreenchange",t),document.addEventListener("webkitfullscreenchange",t),t()})();function Mc(i){Ye.tip.textContent=i,Ye.tip.hidden=!1,Ye.tip.classList.remove("show"),Ye.tip.offsetWidth,Ye.tip.classList.add("show"),clearTimeout(Mc.t),Mc.t=setTimeout(()=>{Ye.tip.hidden=!0},4200)}var Fg=["Listen","Follow","Twist","Stay","Wrap-up"];function Lo(i,e){if(!i){Ye.hud.hidden=!0;return}Ye.hud.hidden=!1,Ye.hud.innerHTML=`
    <div class="hud-l"><span class="mono">0${i.num}</span><span>${Ze(i.title)}</span></div>
    <ol class="hud-parts">${Fg.map((t,n)=>`<li class="${n<e?"done":n===e?"now":""}"><i></i><span>${t}</span></li>`).join("")}</ol>
    <div class="hud-r"><span class="mono" id="clock">${e>=5?"":"0:00"}</span>
      <button class="icon" id="quit" type="button" aria-label="Back to all levels" title="Back to all levels"><svg viewBox="0 0 24 24"><path d="M6 6l12 12M18 6L6 18"/></svg></button></div>`,vt("#quit").onclick=()=>Uo()}setInterval(()=>{let i=vt("#clock");if(i&&Ve.running){let e=Math.floor((performance.now()-Ve.t0)/1e3*lt);i.textContent=`${Math.floor(e/60)}:${String(e%60).padStart(2,"0")}`}},500);function Fu(){if(xe.ctx){let i=xe.now,e={},t=null;for(let n of Ve.talk)if(i>=n.at&&i<n.end){let s=n.spk.actor;e[s]=!0,s==="phone"&&(t=n.spk.name)}for(let n of Object.keys(Lt.actors))Lt.setTalking(n,!!e[n]);t?(Ye.phone.hidden=!1,Ye.phone.querySelector("b").textContent=t):Ye.phone.hidden=!0,Ve.talk=Ve.talk.filter(n=>n.end>i-1);for(let n of Ve.acts)!n.done&&i>=n.at&&(n.done=!0,xe.setLayer(n.act.layer,n.act.to,n.act.ramp/lt),n.then&&xe.rampLayer(n.act.layer,n.then.v,0,n.then.t))}requestAnimationFrame(Fu)}Fu();function mi(i,e,t){let n=t,s=[];for(let r of i){let a=r.clip,o=a[1]/lt,l=e.speakers[r.s];s.push({ln:r,spk:l,at:n,end:n+o,keyT:n+(a[2]||0)/lt}),n=n+o+r.gap/lt}return{items:s,end:s.length?s[s.length-1].end:t}}function gi(i,e){for(let t of i){let n=t.spk.gain!==void 0?t.spk.gain:t.spk.role==="target"?1:.45;xe.play(e.id+".mp3",t.ln.clip,{when:t.at,pan:t.spk.pan||0,gain:n}),Ve.talk.push(t)}}async function Do(i){let e=Ve.runId;for(;xe.now<i;)if(await new Promise(t=>setTimeout(t,60)),e!==Ve.runId)throw new Error("abort")}function Ou(i){let e=i.amb&&i.amb.layers||{};for(let t in xe.layers)t in e||xe.setLayer(t,0,1.5);for(let[t,[n]]of Object.entries(e))xe.setLayer(t,n,1.8)}function Tc(i,e,t,n,s,r){let a=i.amb&&i.amb.layers||{};for(let[o,[l,c]]of Object.entries(a)){if(r&&r[o])continue;let d=xe.layer(o).out.gain,u=l+(c-l)*n,h=l+(c-l)*s;d.cancelScheduledValues(e),d.setValueAtTime(u,e),d.linearRampToValueAtTime(h,Math.max(t,e+.1))}}function No(i){xe.startEvents(i.amb&&i.amb.ev||{},e=>{e==="thunder"&&setTimeout(()=>Lt.flash(1),60)})}function bc(i,{n:e,total:t,label:n="Question"}={}){return new Promise(s=>{let r=Ao(i.o),a=qn("div","qbox");a.innerHTML=`<div class="q-top"><span class="mono">${n} ${e} / ${t}</span><span class="q-hint">Press 1\u20134</span></div>
      <p class="q-text">${Ze(i.q)}</p>
      <div class="q-opts">${r.map((u,h)=>`<button type="button" class="q-opt" data-i="${h}"><kbd>${h+1}</kbd><span>${Ze(u)}</span></button>`).join("")}</div>`,tn(a,"is-q");let o=!1,l=u=>{o||!r[u]||(o=!0,xe.tick(),a.querySelectorAll(".q-opt")[u].classList.add("picked"),d(),ln.delete(d),setTimeout(()=>s({q:i.q,pick:r[u],right:r[u]===i.a,a:i.a}),380/Math.min(lt,3)))},c=u=>{let h=+u.key;h>=1&&h<=4&&l(h-1)};document.addEventListener("keydown",c);let d=()=>document.removeEventListener("keydown",c);ln.add(d),a.querySelectorAll(".q-opt").forEach(u=>u.onclick=()=>l(+u.dataset.i)),pi&&setTimeout(()=>l(Math.random()<.8?r.indexOf(i.a):0),120)})}function Og(i){return new Promise(e=>{let t=Ao(i.tiles),n=i.answer.length,s=[],r=qn("div","task "+(i.style==="map"?"is-map":"")),a=()=>{r.innerHTML=`<div class="q-top"><span class="mono">${Ze(i.prompt)}</span><span class="q-hint">${n} steps \xB7 tap to add, tap a step to remove</span></div>
        ...
        <div class="task-foot"><button type="button" class="ghost" data-act="clear">Clear</button><button type="button" class="go" data-act="ok" ${s.length===n?"":"disabled"}>Lock it in</button></div>`,r.querySelectorAll(".tile").forEach(o=>o.onclick=()=>{s.length<n&&(s.push(t[+o.dataset.i]),xe.tap(),a())}),r.querySelectorAll(".slots li.full").forEach(o=>o.onclick=()=>{s.splice(+o.dataset.i,1),a()}),r.querySelector("[data-act=clear]").onclick=()=>{s.length=0,a()},r.querySelector("[data-act=ok]").onclick=()=>{xe.ok(),e({picked:s.slice(),score:_c(s,i.answer)})}};a(),tn(r,"is-task"),pi&&setTimeout(()=>{let o=Math.random()<.75?i.answer.slice():Ao(i.answer);e({picked:o,score:_c(o,i.answer)})},150)})}function kg(i){return new Promise(e=>{let t=i.fields.map(a=>({f:a,o:Ao(a.o)})),n=i.fields.map(()=>null),s=qn("div","task"),r=()=>{s.innerHTML=`<div class="q-top"><span class="mono">${Ze(i.prompt)}</span><span class="q-hint">One per row</span></div>
        ...
        <div class="task-foot"><span></span><button type="button" class="go" data-act="ok" ${n.every(Boolean)?"":"disabled"}>Lock it in</button></div>`,s.querySelectorAll(".chip").forEach(a=>a.onclick=()=>{n[+a.dataset.r]=a.dataset.v,xe.tap(),r()}),s.querySelector("[data-act=ok]").onclick=()=>{xe.ok(),e({picks:n.slice(),score:yc(n,i.fields)})}};r(),tn(s,"is-task"),pi&&setTimeout(()=>{let a=i.fields.map(o=>Math.random()<.8?o.o[0]:o.o[1]);e({picks:a,score:yc(a,i.fields)})},150)})}var Bg={Listen:"listen",Follow:"follow",Twist:"twist",Stay:"stay","Wrap-up":"wrap"};async function zg(i,e,t){Lo(i,t),tn(null),Lt.setShot(Bg[e.title],2.6),Ou(e),Sc(`${e.title}.`,{accent:0,sub:""});let n=Li(`<div class="card"><p class="eyebrow mono">Part ${t+1} of 5 \xB7 ${Ze(e.title)}</p><p class="card-text">${Ze(e.card||"Last few questions. Think back.")}</p></div>`,"is-part"),s=Io("Hold to tune in");n.querySelector(".card").appendChild(s.el),await s.done,Co(),lr()}async function Vg(i,e){let t=e.amb&&e.amb.layers||{},n=e.chunks.reduce((d,u)=>d+u.lines.reduce((h,f)=>h+(f.clip[1]+f.gap)/lt,0),0),s={},r=(d,u)=>{let[h,f]=t[d],p=s[d];return p?p.to+(f-p.to)*Math.min(1,Math.max(0,(u-p.p)/(1-p.p))):h+(f-h)*u},a=0,o=[];No(e);let l=e.chunks.reduce((d,u)=>d+u.questions.length,0),c=0;for(let d of e.chunks){let u=xe.now+.5/lt,h=mi(d.lines,i,u),f=d.side?mi(d.side.lines,i,u+d.side.at/lt):null,p=h.end-u,y=a/n,m=Math.min(1,(a+p)/n),g={};for(let S of h.items)if(S.ln.act){let w=S.ln.act;g[w.layer]=t[w.layer][0]+(t[w.layer][1]-t[w.layer][0])*y,s[w.layer]={to:w.to,p:(a+(S.at-u))/n},Ve.acts.push({at:S.at,act:w,then:{v:r(w.layer,m),t:h.end}})}for(let S in t){let w=xe.layer(S).out.gain;if(w.cancelScheduledValues(u),S in g){w.setValueAtTime(g[S],u);continue}w.setValueAtTime(r(S,y),u),w.linearRampToValueAtTime(r(S,m),h.end)}gi(h.items,i),f&&gi(f.items,i),await Do(Math.max(h.end,f?f.end:0)+.5/lt),a+=p,xe.duck(!0);for(let S of d.questions)o.push(await bc(S,{n:++c,total:l}));xe.duck(!1),tn(null)}return xe.stopEvents(),{title:e.title,cats:e.scores,score:o.filter(d=>d.right).length/o.length,answers:o}}async function Hg(i,e){No(e);let t=xe.now+.5/lt,n=mi(e.lines,i,t),s=e.side?mi(e.side.lines,i,t+e.side.at/lt):null;Tc(e,t,n.end,0,1),gi(n.items,i),s&&gi(s.items,i),await Do(Math.max(n.end,s?s.end:0)+.6/lt),xe.duck(!0);let r=e.task.kind==="sequence"?await Og(e.task):await kg(e.task);return xe.duck(!1),xe.stopEvents(),tn(null),{title:e.title,cats:e.scores,score:r.score,task:e.task,pick:r}}var Nu={mall:["Missed one. Try saying \u201C47\u201D in your head just before each call.","Hear the number, not the sentence. The number comes first or last."],park:["Missed one. Listen for the word after \u201Cgolden\u201D \u2014 only \u201Ckey\u201D counts.","Let the story wash past. You are only fishing for two words."],football:["Missed one. Keep one ear on your left \u2014 that\u2019s where Coach Tui is.","Voice first, then words. Is it the coach? Then move."],_:["Drifted? That\u2019s normal. Take a breath and tune back in."]};async function Gg(i,e){let t=qn("div","pad "+(e.pad==="arrows"?"is-arrows":"is-tap")),n=[],s=m=>{n.push({t:xe.now,btn:m}),xe.tap();let g=Ve.cues&&Ve.cues.find(w=>w.target&&w.btn===m&&xe.now>=w.keyT-.25&&xe.now<=w.end+2.2&&!w._seen),S=t.querySelector(`[data-b=${m}]`);S&&(S.classList.remove("flash-ok","flash-no"),S.offsetWidth,S.classList.add(g?"flash-ok":"flash-no")),g&&(g._seen=!0)};e.pad==="arrows"?t.innerHTML=`<p class="pad-rule">${Ze("Only Coach Tui. Arrow keys or tap.")}</p>
      <div class="cross">${[["up","Push up","\u2191"],["left","Go left","\u2190"],["right","Go right","\u2192"],["down","Drop back","\u2193"]].map(([m,g,S])=>`<button type="button" class="dir d-${m}" data-b="${m}"><i>${S}</i><span>${g}</span></button>`).join("")}<div class="pitch" aria-hidden="true"></div></div>`:t.innerHTML=`<p class="pad-rule">Tap only on <b>${Ze(e.padLabel)}</b></p><button type="button" class="tapbtn" data-b="tap"><span>Tap</span><kbd>space</kbd></button>`,t.querySelectorAll("[data-b]").forEach(m=>m.addEventListener("pointerdown",g=>{g.preventDefault(),s(m.dataset.b)}));let r={ArrowUp:"up",ArrowDown:"down",ArrowLeft:"left",ArrowRight:"right",Space:"tap"},a=m=>{let g=r[m.code];!g||m.repeat||e.pad==="tap"==(g==="tap")&&(m.preventDefault(),s(g))};document.addEventListener("keydown",a);let o=()=>document.removeEventListener("keydown",a);ln.add(o),tn(t,"is-pad"),No(e);let l=xe.now+.8/lt,c=mi(e.lines,i,l),d=e.side?mi(e.side.lines,i,l+e.side.at/lt):null;Tc(e,l,c.end,0,1),gi(c.items,i),d&&gi(d.items,i);let u=c.items.filter(m=>m.ln.cue).map(m=>({keyT:m.keyT,end:m.end,target:!m.ln.lure,btn:m.ln.cue,text:m.ln.t}));Ve.cues=u;let h=0,f=Nu[i.id]||Nu._,p=u.filter(m=>m.target).map(m=>setTimeout(()=>{!m._seen&&h<2&&Ve.running&&Mc(f[h++%f.length])},(m.end+2.3-xe.now)*1e3));pi&&u.forEach(m=>{let g=m.target?.85:.15;Math.random()<g&&setTimeout(()=>s(m.btn),(m.keyT+.45/lt-xe.now)*1e3)}),await Do(Math.max(c.end,d?d.end:0)+2.4/lt),p.forEach(clearTimeout),o(),ln.delete(o),xe.stopEvents(),tn(null);let y=Iu(u,n,2.2/lt);return{title:e.title,cats:e.scores,score:y.score,cues:y.cues,t0:l,stats:y}}var To=["Ben: sushi?? \u{1F363}","IT Helpdesk: Your password expires in 3 days","Tash: are geese allowed in court","Calendar: Team meeting moved to 9:45","Ben: they have mochi now","Priya (away): Out of office until Monday","Tash: the goose has a LinkedIn"];async function Wg(i,e){let t=qn("div","notes");t.innerHTML=`<div class="q-top"><span class="mono">Your notes</span><span class="q-hint">Marked on ideas, not spelling</span></div>
    <textarea id="notes-${i.id}" rows="5" placeholder="Type the key points as you hear them\u2026" spellcheck="false"></textarea>
    <div class="task-foot"><span class="mono count" id="notes-count">Listening\u2026</span><button type="button" class="go" data-act="ok" disabled>Hand in notes</button></div>`,tn(t,"is-notes");let n=t.querySelector("textarea");setTimeout(()=>n.focus(),50),No(e);let s=xe.now+.8/lt,r=mi(e.lines,i,s),a=e.side?mi(e.side.lines,i,s+e.side.at/lt):null;Tc(e,s,r.end,0,1),gi(r.items,i),a&&gi(a.items,i);let o=null;if(e.notify){let p=0,y=()=>{if(!Ve.running)return;let m=qn("div","toast",`<b>${Ze(To[p%To.length].split(":")[0])}</b><span>${Ze(To[p%To.length].split(":").slice(1).join(":"))}</span>`);p++,Ye.toasts.appendChild(m),xe.fx("ping"),setTimeout(()=>m.remove(),4600),o=setTimeout(y,(6e3+Math.random()*5e3)/lt)};o=setTimeout(y,5e3/lt)}pi&&(n.value=e.keyPoints.slice(0,4).map(p=>p.p.split(" ").slice(0,6).join(" ")).join(`
`)),await Do(r.end+.3/lt),clearTimeout(o);let l=t.querySelector("[data-act=ok]");l.disabled=!1;let c=t.querySelector("#notes-count"),d=Math.round(e.writeTime||25);await new Promise(p=>{l.onclick=p;let y=()=>{c.textContent=`${d}s to finish`,d--<=0?p():y.t=setTimeout(y,1e3/lt)};y(),pi&&setTimeout(p,200);let m=()=>clearTimeout(y.t);ln.add(m)}),xe.stopEvents(),xe.ok();let u=n.value;tn(null);let h=e.lines.map(p=>p.t).join(" "),f=Lu(u,e,h);return{title:e.title,cats:e.scores,score:0,notes:u,marking:f}}async function Xg(i,e){xe.duck(!0);let t=[];for(let[s,r]of e.questions.entries())t.push(await bc(r,{n:s+1,total:e.questions.length+1,label:"Think back"}));let n=await bc(e.sideQ,{n:e.questions.length+1,total:e.questions.length+1,label:"Think back"});return xe.duck(!1),tn(null),{title:e.title,cats:e.scores,score:t.filter(s=>s.right).length/t.length,answers:t,side:n}}async function qg(i){xe.unlock();let e=new Set([i.id+".mp3","shared.mp3"]);for(let o of i.parts){for(let l of Object.keys(o.amb&&o.amb.layers||{}))["crowd","kids","music","chant"].includes(l)&&e.add(l+".mp3");for(let l of Object.keys(o.amb&&o.amb.ev||{}))l==="scream"&&e.add("screams.mp3"),l==="cheer"&&e.add("cheers.mp3")}xe.sfxMan=mc.sfx,Ye.loader.hidden=!1;let t=Ye.loader.querySelector("i"),n=Ye.loader.querySelector("span"),s=[...e],r={},a=()=>{let o=s.reduce((l,c)=>l+(r[c]||0),0)/s.length;t.style.width=Math.round(o*100)+"%",n.textContent=`Tuning in\u2026 ${Math.round(o*100)}%`};await Promise.all(s.map(o=>xe.load(o,l=>{r[o]=l,a()}).then(()=>{r[o]=1,a()}))),Ye.loader.hidden=!0}async function Po(i){vc(),xe.ctx&&(xe.stopVoices(),xe.killLayers()),Ye.toasts.innerHTML="";let e=Ve.runId;Ve.level=i,Ve.results=[],Co(),lr(),tn(null),Lt.levelId!==i.id&&Lt.load(i.id);try{await qg(i),Lo(i,-1),Lt.setShot("intro",2.4);let t=i.parts[1];Ou(t),Sc(i.title,{accent:i.title.split(" ").length-1,sub:`${i.place} \xB7 ages ${i.ages}`});let n=Li(`<div class="card"><p class="eyebrow mono">Level 0${i.num} \xB7 headphones on</p>
      <p class="card-text">${Ze(i.blurb)}</p>
      <div class="hp"><button type="button" class="chip" data-hp="L">Left ear</button><button type="button" class="chip" data-hp="R">Right ear</button><span class="q-hint">Voices come from different sides. Check both. Move your mouse, or drag, to look around.</span></div></div>`,"is-part"),s=l=>xe.play("shared.mp3",mc.shared.clips[l==="L"?"hp_left":"hp_right"],{pan:l==="L"?-1:1,gain:.9});n.querySelectorAll("[data-hp]").forEach(l=>l.onclick=()=>s(l.dataset.hp)),setTimeout(()=>{Ye.screens.contains(n)&&(s("L"),setTimeout(()=>Ye.screens.contains(n)&&s("R"),1700/lt))},900/lt);let r=Io("Hold to tune in");if(n.querySelector(".card").appendChild(r.el),await r.done,e!==Ve.runId)return;Co(),lr(),Ve.running=!0,Ve.t0=performance.now(),Ve.levelT0=xe.now;let a={listen:Vg,task:Hg,respond:Gg,notes:Wg,wrap:Xg},o=0;for(let l of i.parts){if(l.type==="intro")continue;if(await zg(i,l,o),e!==Ve.runId)return;let c=await a[l.type](i,l);if(e!==Ve.runId)return;c.type=l.type,Ve.results.push(c),o++}Ve.running=!1,await Yg(i,e)}catch(t){if(e!==Ve.runId)return;Ve.running=!1,t.message!=="abort"&&(console.error(t),Li(`<div class="card"><p class="eyebrow mono">Something went wrong</p><p class="card-text">${Ze(t.message||t)}. Check your connection and try again.</p><button class="go" type="button" id="back">All levels</button></div>`,"is-part"),vt("#back").onclick=()=>Uo())}}async function Yg(i,e){Lo(i,5),Lt.setShot("wrap",3),xe.silenceLayers([],3),tn(null),Ye.toasts.innerHTML="";let t=Ve.results.find(h=>h.marking);if(t){let h=Li('<div class="card"><p class="eyebrow mono">Marking your notes\u2026</p><p class="card-text">If Claude asks, allow it to mark your notes. Otherwise they\u2019re marked by keyword matching.</p></div>',"is-part"),f=await t.marking;if(e!==Ve.runId)return;t.score=f.score,t.mark=f,h.remove()}let n=Du(i,Ve.results),s=Ve.results.find(h=>h.type==="wrap"),r=s&&s.answers.every(h=>h.right),a=s&&s.side.right,o=a&&!r?i.side.line:a?`You caught ${i.side.who} and the details that mattered. Big ears.`:`You didn\u2019t take in ${i.side.who} at all. That\u2019s filtering.`,l=pn.get("best."+i.id);(l===null||n.overall>l)&&pn.set("best."+i.id,n.overall);let c=[];Ve.results.forEach(h=>{(h.answers||[]).forEach(f=>!f.right&&c.push(`${f.q} \u2014 <b>${Ze(f.a)}</b>`)),h.task&&h.score<1&&c.push(`${Ze(h.task.prompt)} \u2014 <b>${Ze(h.task.kind==="sequence"?h.task.answer.join(" \u2192 "):h.task.fields.map(f=>f.o[0]).join(" \xB7 "))}</b>`)});let d=Ii[Ii.indexOf(i)+1],u=Li(`
    <div class="results">
      ...
      <ul class="bars">${So.map(h=>{var f;return`<li><div class="bar-top"><span>${h.name}</span><span class="mono">${(f=n.sub[h.id])!=null?f:"\u2013"}</span></div><div class="bar"><i style="--v:${(n.sub[h.id]||0)/100}"></i></div><small>${h.blurb}</small></li>`}).join("")}</ul>
    ...
    </div>`,"is-results");u.querySelector("#again").onclick=()=>Po(i),d&&(u.querySelector("#next").onclick=()=>Po(d)),u.querySelector("#all").onclick=()=>Uo(),requestAnimationFrame(()=>u.classList.add("in")),window.__attune.summary=n}function $g(i){return i?i<10?"mall":i<12?"park":i<13?"football":i<18?"lab":"office":null}function Zg(i,e){let t=pn.get("age"),n=qn("div","modal",`<div class="modal-card" role="dialog" aria-modal="true" aria-labelledby="age-h">
      ...
      <div class="modal-foot"><button type="button" class="ghost" data-act="skip">Skip</button><button type="button" class="go" data-act="ok">Show my level</button></div></div>`);i.appendChild(n);let s=n.querySelector("#age-pop"),r=n.querySelector("[data-act=ok]"),a=()=>{let u=Math.round(+s.value);return u>=5&&u<=99?u:null},o=()=>{r.disabled=!a()},l=u=>{document.removeEventListener("keydown",c,!0),ln.delete(d),n.remove(),e(u)},c=u=>{u.key==="Escape"?(u.stopImmediatePropagation(),u.preventDefault(),l(null)):u.key==="Enter"&&a()&&(u.stopImmediatePropagation(),u.preventDefault(),xe.ok(),l(a()))},d=()=>document.removeEventListener("keydown",c,!0);document.addEventListener("keydown",c,!0),ln.add(d),n.querySelectorAll(".step").forEach(u=>u.onclick=()=>{s.value=Math.max(5,Math.min(99,(a()||11)+ +u.dataset.d)),xe.tick(),o()}),s.addEventListener("input",o),r.onclick=()=>{a()&&(xe.ok(),l(a()))},n.querySelector("[data-act=skip]").onclick=()=>l(null),n.addEventListener("pointerdown",u=>{u.target===n&&l(null)}),o(),setTimeout(()=>s.focus(),60)}function Uo(i,{askAge:e=!1}={}){vc(),Lo(null),tn(null),lr(),Ye.toasts.innerHTML="",Ye.phone.hidden=!0,xe.ctx&&(xe.stopVoices(),xe.killLayers());let t=typeof i=="string"&&i||pn.get("last")||Ii[0].id,n=Li(`
    <div class="levels">
      <div class="lv-head"><button type="button" class="back" id="back-title"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M15 5l-7 7 7 7"/></svg>Back</button><p class="eyebrow mono">ATTune \xB7 listening levels</p><h2>Pick a place</h2>
        <div class="age-row"><span class="mono">Your age</span><b class="mono" id="age-show">\u2013</b><button type="button" class="link-btn" id="age-change">Change</button></div></div>
      <ol class="lv-list">${Ii.map(d=>{let u=pn.get("best."+d.id);return`
        <li data-id="${d.id}"><button type="button" class="lv">
          <span class="lv-n mono">0${d.num}</span>
          <span class="lv-main"><span class="lv-place mono">${Ze(d.place)} \xB7 ${Ze(d.ages)}</span><span class="lv-title">${Ze(d.title)}</span><span class="lv-blurb">${Ze(d.blurb)}</span></span>
          <span class="lv-side">${u!==null?`<span class="mono best">Best ${u}</span>`:""}<span class="rec">Recommended for you</span></span>
        </button><div class="lv-go"></div></li>`}).join("")}</ol>
    </div>`,"is-levels"),s=()=>{let d=pn.get("age"),u=$g(d);return n.querySelector("#age-show").textContent=d||"\u2013",n.querySelector("#age-change").textContent=d?"Change":"Add",n.querySelectorAll(".lv-list li").forEach(h=>h.classList.toggle("is-rec",h.dataset.id===u)),u},r=()=>{vc(),Co(),ku()};n.querySelector("#back-title").onclick=r;let a=d=>{d.key==="Escape"&&!document.querySelector(".modal")&&r()};document.addEventListener("keydown",a),ln.add(()=>document.removeEventListener("keydown",a));let o=null,l=d=>{t=d,pn.set("last",d),o&&o.dispose(),n.querySelectorAll(".lv-list li").forEach(f=>{f.classList.toggle("sel",f.dataset.id===d),f.querySelector(".lv-go").innerHTML=""});let u=n.querySelector(`li[data-id="${d}"]`);o=Io("Hold to tune in"),u.querySelector(".lv-go").appendChild(o.el);let h=Ii.find(f=>f.id===d);return o.done.then(()=>{wc(),Po(h)}),Lt.levelId!==d&&(Lt.load(d),Lt.setShot("intro",0)),u},c=()=>Zg(n,d=>{d&&pn.set("age",d);let u=s();if(d&&u){let h=l(u);h.scrollIntoView({block:"nearest",behavior:"smooth"}),h.querySelector(".lv").focus({preventScroll:!0})}});n.querySelector("#age-change").onclick=c,n.querySelectorAll(".lv").forEach(d=>d.onclick=()=>{xe.unlock(),l(d.parentElement.dataset.id)}),s(),l(t),e&&!pi&&c()}function ku(){Lt.levelId!=="mall"&&Lt.load("mall"),Lt.setShot("intro",0),Sc("AT TUNE",{accent:1,sub:"Five places. One voice to follow.",cls:"title"});let i=Li('<div class="title-foot"><p class="card-text">A listening game. Headphones on, sound up. Pick out the voice that matters while everything else competes for your attention.</p><div class="title-actions"></div><p class="look-hint">Move your mouse (or drag) to look around.</p></div>',"is-title"),e=Io("Hold to tune in");i.querySelector(".title-actions").appendChild(e.el),e.done.then(()=>{wc(),lr(),Uo(null,{askAge:!0})})}function Jg(){let i=Eo.get("level")&&Ii.find(e=>e.id===Eo.get("level"));i?(Lt.load(i.id),Po(i)):ku()}var Kg=document.fonts&&document.fonts.ready?Promise.race([document.fonts.ready,new Promise(i=>setTimeout(i,1800))]):Promise.resolve();Kg.then(Jg);})();
